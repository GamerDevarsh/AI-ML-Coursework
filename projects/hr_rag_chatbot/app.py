...
retriever = vectorstore.as_retriever(search_kwargs={"k": 4}) #(search_type = "similarity_score_threshold", search_kwargs={"score_threshold": 0.5}) search_type = "mmr" also  possibel
