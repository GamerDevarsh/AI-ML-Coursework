...
def ask_question(runtime: ChatbotRuntime, question: str) -> str:
    ...
    # if (not answer_text.strip()) or ("i don't have enough information" in answer_text.lower()):
    #     try:
    #         messages = runtime.memory.chat_memory.messages
    #         last_user = None
    ...
    #         if last_user:
    #             fallback = (
    #                 f"We were discussing: {last_user}\n\n"
    #                 "(Note: this answer comes from conversation memory, not the document corpus.)"
    #             )
